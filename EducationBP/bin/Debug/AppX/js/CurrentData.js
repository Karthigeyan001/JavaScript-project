(function () {
    ...
    WinJS.Namespace.define("CurrentData", {
        items: groupedItems,
    ...
    function generateSampleData() {
        ...
        // separately.
        var sampleGroups = [
            { key: "group1", title: "news ‘n’ <b>updates</b>", subtitle: "Group Subtitle: 1", backgroundImage: "../../images/HubPage/CampusLife1.png", description: groupDescription },
            { key: "group2", title: "events ‘n’ <b>programs</b>", subtitle: "Group Subtitle: 2", backgroundImage: "../../images/HubPage/CuHappening2.png", description: groupDescription },
        ...
        // group.
        var sampleItems = [
            { group: sampleGroups[0], title: "Lorem ipsum dolor sit amet", subtitle: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam venenatis laoreet sollicitudin. Cras placerat, lectus id consequat tincidunt, ligula justo pellentesque nunc, et ultrices ligula ante id", recordType: RecordType1.big1, description: itemDescription, content: itemContent, backgroundImage: "../../images/HubPage/CuHappening1.png" },
            { group: sampleGroups[0], title: "Lorem ipsum dolor sit amet", subtitle: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam venenatis laoreet sollicitudin. Cras placerat, lectus id consequat tincidunt, ligula justo pellentesque nunc, et ultrices ligula ante id", recordType: RecordType1.big1, description: itemDescription, content: itemContent, backgroundImage: "../../images/HubPage/CuHappening2.png" },
            { group: sampleGroups[0], title: "Lorem ipsum dolor sit amet", subtitle: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam venenatis laoreet sollicitudin. Cras placerat, lectus id consequat tincidunt, ligula justo pellentesque nunc, et ultrices ligula ante id", recordType: RecordType1.big1, description: itemDescription, content: itemContent, backgroundImage: "../../images/HubPage/CuHappening3.png" },
            { group: sampleGroups[0], title: "Lorem ipsum dolor sit amet", subtitle: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam venenatis laoreet sollicitudin. Cras placerat, lectus id consequat tincidunt, ligula justo pellentesque nunc, et ultrices ligula ante id", recordType: RecordType1.big1, description: itemDescription, content: itemContent, backgroundImage: "../../images/HubPage/CuHappening2.png" },
            //{ group: sampleGroups[0], title: "Item Title: 5", subtitle: "Item Subtitle: 5", description: itemDescription, content: itemContent, backgroundImage: mediumGray },

            { group: sampleGroups[1], title: "<b>live jam</b> &nbsp by faculty ", subtitle: "<b>seminar</b> room", backgroundColor: "#ffd458", color: "#000", recordType: RecordType1.smaller1, description: itemDescription, content: itemContent, backgroundImage: "../../images/HubPage/CampusLife1.png" },
            { group: sampleGroups[1], title: "<b>macbeth</b> rendition", subtitle: "<b>royal </b> hall", backgroundColor: "#36c986", color: "#443161", recordType: RecordType1.smaller1, description: itemDescription, content: itemContent, backgroundImage: "../../images/HubPage/CuHappening1.png" },
            { group: sampleGroups[1], title: "<b>knights</b> vs. hawks", subtitle: "<b>football</b> stadium", backgroundColor: "#c93682", color: "#ffd458", recordType: RecordType1.smaller1, description: itemDescription, content: itemContent, backgroundImage: "../../images/HubPage/CuHappening3.png" },
            { group: sampleGroups[1], title: "<b>coldplay </b> live", subtitle: "<b>stanley </b> hall", recordType: RecordType1.medium1, backgroundColor: "#c93682", color: "#ffd458", description: itemDescription, content: itemContent, backgroundImage: "../../images/HubPage/CampusLife3.png" },
            { group: sampleGroups[1], title: "<b>poetry</b> open house", subtitle: "<b>simon </b> garden", backgroundColor: "#ffd458", color: "#000", recordType: RecordType1.smaller1, description: itemDescription, content: itemContent, backgroundImage: "../../images/HubPage/CampusLife1.png" },
            { group: sampleGroups[1], title: "<b>knights</b> vs. hawks", subtitle: "<b>football</b> stadium", backgroundColor: "#c93682", color: "#ffd458", recordType: RecordType1.smaller1, description: itemDescription, content: itemContent, backgroundImage: "../../images/HubPage/CuHappening3.png" },
            { group: sampleGroups[1], title: "<b>live jam</b> &nbsp by faculty ", subtitle: "<b>seminar</b> room", backgroundColor: "#ffd458", color: "#000", recordType: RecordType1.smaller1, description: itemDescription, content: itemContent, backgroundImage: "../../images/HubPage/CampusLife1.png" },
            { group: sampleGroups[1], title: "<b>macbeth</b> rendition", subtitle: "<b>royal </b> hall", backgroundColor: "#36c986", color: "#443161", recordType: RecordType1.smaller1, description: itemDescription, content: itemContent, backgroundImage: "../../images/HubPage/CuHappening1.png" },
            { group: sampleGroups[1], title: "<b>poetry</b> open house", subtitle: "<b>three year</b> course", backgroundColor: "#36c986", color: "#443161", recordType: RecordType1.smaller1, description: itemDescription, content: itemContent, backgroundImage: "../../images/HubPage/CuHappening1.png" },
            { group: sampleGroups[1], title: "<b>coldplay </b> live", subtitle: "<b>stanley </b> hall", recordType: RecordType1.medium1, backgroundColor: "#c93682", color: "#ffd458", description: itemDescription, content: itemContent, backgroundImage: "../../images/HubPage/CampusLife3.png" },
